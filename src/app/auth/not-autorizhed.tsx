  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F3F4F6] p-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md text-center border border-gray-100 transition-all hover:shadow-2xl">
        ...
        {/* Ikon Gembok Gede (Ganti Foto di Gambar 7 biar lebih modern) */}
        ...
        {/* Teks Peringatan (Persis Gambar 7a) */}
        ...
        {/* Tombol Kembali ke Login (Poin 7b) */}
        <button 
        ...
        {/* Variasi: Tombol Register (Biar User Gak Bingung) */}
